...
const STRINGS = {
  en: {
    ...
    weapon: { wasp: "WASP", pulsar: "PULSAR", grizzly: "GRIZZLY" },
    char: {
      assault: {
        name: "ASSAULT",
        ...
        abilities: {
          ...
          special: {
            name: "GRENADE",
            levels: ["Frag grenade", "+2 fragments", "+50% blast radius"],
          },
        },
      },
      medic: {
        ...
        abilities: {
          ...
          ult: {
            name: "AURA",
            levels: ["Healing aura 5 sec", "+50% radius", "+2 HP/tick"],
          },
          special: {
            name: "HEAL SHOT",
            levels: ["Uses ammo, heals 3 HP", "Heals 5 HP", "Cures bleeding"],
          },
        },
      },
      ninja: {
      ...
      heavy: {
        ...
        abilities: {
          ...
          special: {
            name: "ARMOR WALL",
            levels: ["Blocks enemies", "+50% durability", "Places 2 walls"],
          },
        },
      },
      pyro: {
        ...
        abilities: {
          dash: {
            name: "FIRE TRAIL",
            levels: ["Leaves fire trail", "+50% duration", "Trail explodes"],
          },
          ult: {
            name: "FIRE STORM",
            levels: ["360° fire for 5 sec", "+50% radius", "Burn: 3 dmg/tick"],
          },
          special: {
            name: "IGNITE ROUND",
            levels: [
    ...
    pause: { title: "PAUSE", resume: "RESUME", mainMenu: "MAIN MENU" },
    death: {
      title: "DEFEATED",
      time: "TIME",
      score: "SCORE",
  ...
  ru: {
    ...
    weapon: { wasp: "ОСА", pulsar: "ИМПУЛЬС", grizzly: "ГРИЗЛИ" },
    char: {
      assault: {
        name: "ШТУРМОВИК",
        ...
        abilities: {
          ...
          special: {
            name: "ГРАНАТА",
            levels: ["Осколочная граната", "+2 осколка", "+50% радиус взрыва"],
          },
        },
      },
      medic: {
        ...
        abilities: {
          ...
          ult: {
            name: "АУРА",
            levels: ["Аура лечения 5 сек", "+50% радиус", "+2 ХП/тик"],
          },
          special: {
            name: "ЛЕЧЕБНЫЙ ВЫСТРЕЛ",
            levels: [
              "Тратит патроны, лечит 3 ХП",
              "Лечит 5 ХП",
              "Останавливает кровь",
            ],
          },
      ...
      heavy: {
        ...
        abilities: {
          dash: {
            name: "ТАРАН",
            levels: ["Рывок с отбрасыванием", "+10 урона", "Сбивает врагов"],
          },
          ult: {
            name: "ЩИТ",
            levels: [
              "Блок 100% урона 3 сек",
              "+2 сек длительности",
              "Щит взрывается",
            ],
          },
          special: {
            name: "БРОНЕСТЕНА",
            levels: ["Блокирует врагов", "+50% прочности", "Ставит 2 стены"],
          },
        },
      },
      pyro: {
        ...
        abilities: {
          ...
          ult: {
            name: "ОГНЕННАЯ БУРЯ",
            levels: ["Огонь 360° на 5 сек", "+50% радиус", "Горение: 3 ур/тик"],
          },
          special: {
            name: "ЗАЖИГАТЕЛЬНЫЙ",
            levels: ["Поджигает врага", "Горит дольше", "Перекидывается"],
          },
        },
      },
    },
    ...
    pause: { title: "ПАУЗА", resume: "ПРОДОЛЖИТЬ", mainMenu: "ГЛАВНОЕ МЕНЮ" },
    death: {
      title: "ПОРАЖЕНИЕ",
      time: "ВРЕМЯ",
      score: "СЧЁТ",
