...
// Debug: populated each frame for render.js
let steeringRays = [];

function getSteeringDirection(enemy, obstacles, enemies) {
  const desiredAngle = Math.atan2(player.worldY - enemy.worldY, player.worldX - enemy.worldX);
